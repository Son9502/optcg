...
public class DeckTest {
    @Test
    /**
     * Tests the drawTop method of the Deck class by adding multiple cards to a
     * deck,
     * drawing the top card, and verifying that the drawn card is correct and that
     * the size
     * of the deck is updated correctly after drawing. If all assertions pass, it
     ...
     * searching for cards that match a specific condition, and verifying that the
     * correct cards are returned
     * and that the size of the deck remains unchanged after searching. If all
     * assertions pass, it prints a success message.
     */
     ...
     * the card, and verifying that the drawn card is correct and that the size of
     * the deck is
    ...
    @Test
    /**
     * Tests the draw method of the Deck class when the deck is empty by attempting
     * to draw a card
     * from an empty deckand verifying that the result is null and that the size of
